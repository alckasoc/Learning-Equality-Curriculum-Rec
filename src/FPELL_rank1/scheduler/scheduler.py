...
def get_scheduler(optimizer, scheduler_type, scheduler_cfg):
    ...
    if scheduler_type == 'constant_schedule_with_warmup':
        ...
        scheduler = get_linear_schedule_with_warmup(
            ...
            num_training_steps=scheduler_cfg.linear_schedule_with_warmup.num_train_steps
        )
        ...
        scheduler = get_cosine_schedule_with_warmup(
            ...
            num_training_steps=scheduler_cfg.cosine_schedule_with_warmup.num_train_steps,
        )
        ...
        scheduler = get_polynomial_decay_schedule_with_warmup(
            ...
            num_training_steps=scheduler_cfg.polynomial_decay_schedule_with_warmup.num_train_steps,
